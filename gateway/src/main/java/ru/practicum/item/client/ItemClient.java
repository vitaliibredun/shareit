...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> findItem(Integer userId, Integer itemId) {
        return get("/" + itemId, userId);
    }

    public ResponseEntity<Object> findAllItemsByUser(Integer userId, Integer from, Integer size) {
    ...
    public ResponseEntity<Object> searchItemForRent(String text, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "text", text,
                "from", from,
                "size", size);
